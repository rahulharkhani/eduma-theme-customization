...
//				}
	...
	if ( isset( $_GET['result'] ) && $_GET['result'] == 'registered' ) :
		...
		echo '<p class="message message-success">' . esc_html__( 'Registration is successful. Your account has to be confirmed by an administrator before you can login.', 'eduma' ) . '</p>';
